...
pub async fn advance_world_newspaper(
    ...
    let (draft, journalist_receipts) =
        run_assigned_journalists(model, &prepared, &agenda, &receipts)
            .await
            .map_err(|failure| {
