...
fn schema_catalog() -> Value {
    json!({
        ...
        "ghostlight.world_newspaper_request.v3": schemars::schema_for!(crate::consumer::WorldNewspaperRequest),
...
mod tests {
    ...
    fn health_is_read_from_the_same_typed_mesh_record_that_is_published() {
        ...
        assert!(schemas["ghostlight.world_newspaper_request.v3"]["$schema"].is_string());
