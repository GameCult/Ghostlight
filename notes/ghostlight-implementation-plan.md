...
4. Run the first full-story artifact pass.
   ...
   - Website-content correction: each complete scene should include an art-direction block with establishing shot, light/color, bodies/interfaces, material evidence, branch-visible marks, and an image prompt seed. Visual continuity is part of consequence carryover, not decorative garnish applied after the story escapes containment.
